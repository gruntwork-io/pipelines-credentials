...
pipelines_token="$(curl -s -H "Authorization: Bearer $PROVIDER_TOKEN" "https://aperture-dev-git-pipelines-api-gruntwork.vercel.app/api/v1/tokens/pat/$PIPELINES_TOKEN_PATH")"
